...
class TestBatchPrediction:
    ...
    def test_batch_predict_valid(self, valid_batch_request):
        ...
        response = client.post("/batch-predict", json=valid_batch_request)
    ...
    def test_batch_predict_empty_list(self):
        ...
        response = client.post("/batch-predict", json={"instances": []})
        assert response.status_code == 422
    ...
    def test_batch_predict_too_many_instances(self):
        ...
        response = client.post("/batch-predict", json={"instances": instances})
        assert response.status_code == 422
