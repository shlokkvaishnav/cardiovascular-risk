...
class TestPredictionEndpoints:
    ...
    def test_predict_valid_request(self, valid_request_data):
        ...
        response = client.post("/predict", json=valid_request_data, headers={"X-API-Key": "cardiovascular-risk-secret-key-123"})
    ...
    def test_predict_invalid_age(self, valid_request_data):
        ...
        response = client.post("/predict", json=invalid_data, headers={"X-API-Key": "cardiovascular-risk-secret-key-123"})
    ...
    def test_predict_missing_field(self, valid_request_data):
        ...
        response = client.post("/predict", json=incomplete_data, headers={"X-API-Key": "cardiovascular-risk-secret-key-123"})
...
class TestBatchPrediction:
    ...
    def test_batch_predict_valid(self, valid_batch_request):
        ...
        response = client.post("/batch-predict", json=valid_batch_request, headers={"X-API-Key": "cardiovascular-risk-secret-key-123"})
    ...
    def test_batch_predict_empty_list(self):
        ...
        response = client.post("/batch-predict", json={"instances": []}, headers={"X-API-Key": "cardiovascular-risk-secret-key-123"})
        assert response.status_code == 422
    ...
    def test_batch_predict_too_many_instances(self):
        ...
        response = client.post("/batch-predict", json={"instances": instances}, headers={"X-API-Key": "cardiovascular-risk-secret-key-123"})
        assert response.status_code == 422
...
class TestRequestValidation:
    ...
    def test_heart_rate_validation(self):
        ...
        response = client.post("/predict", json=data, headers={"X-API-Key": "cardiovascular-risk-secret-key-123"})
    ...
    def test_boundary_values(self):
        ...
        response = client.post("/predict", json=min_data, headers={"X-API-Key": "cardiovascular-risk-secret-key-123"})
        ...
        response = client.post("/predict", json=max_data, headers={"X-API-Key": "cardiovascular-risk-secret-key-123"})
